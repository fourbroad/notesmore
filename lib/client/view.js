...
inherits(View, Document, {
  ...
  _buildQuery: function(){
    let _this = this, body = {body:{}}, 
        searchFields = _.filter(this.search.fields, function(sf) { return sf.visible == undefined || sf.visible == true; }),
        bool = _.reduce(searchFields, function(bool, sf){
      switch(sf.type){
        case 'keywords':
  ...
  findDocuments: function(options, callback) {
    ...
    const domainId = this.domainId, _this = this, viewId = this.id, client = this.getClient();
