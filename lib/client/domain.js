...
_.assign(Domain, {
  ...
  create: function(id, domainRaw, options, callback){
    if(arguments.length == 1 && typeof arguments[0] == 'object'){
      ...
      domainRaw = id;
      id = uuidv4();
    } else if(arguments.length == 2 && typeof arguments[0] == 'object' && typeof arguments[0] == 'object'){
      options = domainRaw;
      domainRaw = id;
      id = uuidv4();
    } else if(arguments.length == 2 && typeof arguments[0] == 'object' && typeof arguments[0] == 'function'){
      callback = domainRaw;
      domainRaw = id;
      id = uuidv4();
...
inherits(Domain, Document, {
  ...
  saveAs: function(id, title, callback){
    if(arguments.length == 1 && typeof arguments[0] == 'function'){
  	...
  	var newDom = _.cloneDeep(this), opts = {};

   	newDom.title = title;
   	delete newDom.id;

   	if(newDom._meta.roadmap){
   	  opts.roadmap = newDom._meta.roadmap;
   	}

	
	Domain.create(this.id, newDom, opts, callback);
  },
  ...
  delete: function(options, callback){
    ...
    client.emit('deleteDomain', this.id, options, function(err, result) {
      if(err) return callback ? callback(err) : console.error(err);
