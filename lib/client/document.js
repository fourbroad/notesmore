...
_.assign(Document, {
  ...
  find: function(domainId, collectionId, query, callback) {
    ...
    client.emit('findDocuments', domainId, collectionId, query, function(err, data) {
      if(err) return callback ? callback(err) : console.error(err);
  ...
  　}
    ...
    client.emit('scroll', params, function(err, data) {
      if(err) return callback ? callback(err) : console.error(err);
...
_.assign(Document.prototype, {
  ...
  getEvents: function(callback){
    ...
    client.emit('getEvents', this.domainId, this.collectionId, this.id, callback);
  },
