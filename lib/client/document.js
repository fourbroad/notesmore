...
_.assign(Document, {
  ...
  create: function(domainId, collectionId, id, docRaw, options, callback){
    if(arguments.length == 3 && typeof arguments[2] == 'object'){
      ...
      docRaw = id;
      id = uuidv4();
    } else if(arguments.length == 4 && typeof arugments[2] == 'object' && typeof arugments[3] == 'object'){
      options = docRaw;
      docRaw = id;
      id = uuidv4();
    } else if(arguments.length == 4 && typeof arugments[2] == 'object' && typeof arugments[3] == 'function'){
      callback = docRaw;
      docRaw = id;
      id = uuidv4();
...
_.assign(Document.prototype, {
  ...
  getEvents: function(options, callback){
    ...
    client.emit('getEvents', this.domainId, this.collectionId, this.id, options, callback);
  },
