...
let login_post = function (){
    ...
    //return new Promise(function(resolve, reject){
        return  axios.post("http://47.100.213.55:3000/_login",{"id":"ah-old-system-history","password":"raiJ9ahv"})
...
let get_policies = function (toket,startId,limit){
    //return new Promise(function(resolve, reject){
        return  axios.get("http://dicc.ins24.com/ah/esPoliciesHistory?limit="+limit+"&startId="+startId)
        .then(function (response) {
