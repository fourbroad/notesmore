...
let login_post = function (){
    ...
    return new Promise(function(resolve, reject){
        axios.post("http://47.100.213.55:3000/_login",{"id":"ah-old-system-history-endorse","password":"deeBeip9"})
...
let get_policies = function (toket,startId,limit){
    return new Promise(function(resolve, reject){
        axios.get("http://dicc.ins24.com/ah/esCorrectHistory?limit="+limit+"&startId="+startId)
        .then(function (response) {
