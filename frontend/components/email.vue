  ...
  <div class="email-container full-container">
    <div class="email-app">
      <div class="email-side-nav remain-height ov-h">
        <div class="h-100 layers">
          <div class="p-20 bgc-grey-100 layer w-100">
            <a href="javascript:void(0)" class="new-message btn btn-danger btn-block">New Message</a>
          </div>
            ...
            <ul class="p-20 nav flex-column">
                ...
                <a href="javascript:void(0)" class="nav-link c-grey-800 cH-blue-500 active">
                  <div class="peers ai-c jc-sb">
                    <div class="peer peer-greed">
                      <i class="mR-10 fa fa-envelope-o"></i>
                      <span>Inbox</span>
                    </div>
                    <div class="peer">
              ...
              <li class="nav-item">
                <a href class="nav-link c-grey-800 cH-blue-500">
                  <div class="peers ai-c jc-sb">
                    <div class="peer peer-greed">
                      <i class="mR-10 fa fa-share-square-o"></i>
                      <span>Sent</span>
                    </div>
                    <div class="peer">
              ...
              <li class="nav-item">
                <a href class="nav-link c-grey-800 cH-blue-500">
                  <div class="peers ai-c jc-sb">
                    <div class="peer peer-greed">
                      <i class="mR-10 fa fa-exclamation"></i>
                      <span>Spam</span>
                    </div>
                    <div class="peer">
      ...
      <div class="email-wrapper row remain-height bgc-white ov-h">
            ...
            <div class>
              <div class="email-list-item peers fxw-nw p-20 bdB bgcH-grey-100 cur-p">
                ...
                <div class="peer peer-greed ov-h">
                  ...
                  <span
                    class="whs-nw w-100 ov-h tov-e d-b"
        ...
        <div class="email-compose d-none">
